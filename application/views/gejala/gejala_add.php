      ...
      <div class="page-content d-flex align-items-stretch"> 
		...
		<form method="post" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="NM_GEJALA" value="<?=isset($default['NM_GEJALA'])? $default['NM_GEJALA'] : ""?>">
				</div>
			</div>
      <div class="form-group">
        <label class="control-label col-sm-2">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="BOBOT_GEJALA" value="<?=isset($default['BOBOT_GEJALA'])? $default['BOBOT_GEJALA'] : ""?>">
        </div>
      </div>
			<center>
