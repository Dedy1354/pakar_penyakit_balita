...
<html>
  <head>
    ...
    <title>Sitem Pakar Balita</title>
  ...
  <body>
	...
	<a href="add_gejala" class="btn btn-primary">Tambah Data Gejala</a>
	<table class="table">
		<thead>
			<tr>
				<th>No</th>
		...
		<tbody>
			...
			foreach($list_gejala as $row){
				...
				<tr>
					<td>$no</td>
					<td>$row[NM_GEJALA]</td>
          <td>$row[BOBOT_GEJALA]</td>
					<td>
						<a href='edit_gejala/$row[ID_GEJALA]' class='btn btn-sm btn-info'>Update</a>
						<a href='delete_gejala/$row[ID_GEJALA]' class='btn btn-sm btn-danger'>Hapus</a>
					</td>
				</tr>
				";
				$no++;
