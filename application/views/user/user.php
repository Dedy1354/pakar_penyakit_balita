            ...
            <div class="container-fluid">              
                <div class="card">
                  <div class="card-header">
                    <h3 class="h4">Form Diagnosa 
                    <?php echo $username; ?>
                    </h3>
                  </div>
                  <div class="card-body">

                    <p>Pilih gejala penyakit</p>
                    <form method="post" action="<?php echo site_url('user/result') ?>">
                      <div class="row">
                      <?php
                        $no = 0;
                      ...
                      ?>
                            <div class="col-sm-4">                            
                              <div class="i-checks">
                                <input type="checkbox" name="<?php echo $name;?>" value="<?php echo  $row['ID_GEJALA']?>"  class="checkbox-template">
                                <label><?php echo $row['NM_GEJALA']; ?></label>
                              </div>
                            </div>
                      ...
                      ?>
                        ...
                        <input type="hidden" name="resrow" value="<?php echo $no; ?>">
                      <div class="form-group">       
                        <input type="submit" value="Hasil" class="btn btn-primary">
                      </div>
                   ...
                   <table class="table table-sm table-bordered table-hover">
                        <thead>
                          <tr>
                            ...
                            <th class="table-primary">GEJALA</th>
                            <th class="table-primary">TANGGAL DIAGNOSIS</th>
                            <th class="table-primary">DIAGNOSA</th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          foreach($list_diagnosa as $row){
                            ...
                            <tr>
                              ...
                              <td><?php echo User::tanggal_indo($row['TGL_DIAGNOSA']);?></td>
