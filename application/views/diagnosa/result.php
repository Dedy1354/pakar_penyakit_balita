      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    ...
                    <li><a href="<?php echo site_url('Admin/gejala')?>"> <i class="icon-bill"></i>Data Gejala</a></li>                    <!-- <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Example dropdown </a>
          ...
          <!-- Dashboard Counts Section-->
            ...
            <div class="container-fluid">              
                <div class="card">
                  ...
                  <a href="<?php echo site_url('/admin/add_diagnosa'); ?>" class="btn btn-warning">Diagnosa Kembali</a>
