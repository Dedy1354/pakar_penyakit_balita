...
<div class="container">
	...
	<a href="add_pasien" class="btn btn-primary">Tambah Data Pasien</a>
	<table class="table table-condensed table-bordered">
		...
		<tbody>
          ...
          <td><?php echo $row['PASSWORD'];?></td>
					<td><?php echo Admin::tanggal_indo($row['UMUR_PASIEN']);?></td>
					<td><?php echo $row['ALAMAT_PASIEN'];?></td>
					<td><?php echo $row['GENDER_PASIEN'];?></td>
					<td>
						<a href='edit_pasien/<?php echo $row["ID_PASIEN"];?>' class='btn btn-sm btn-info'>Update</a>
						<a href='delete_Pasien/<?php echo $row["ID_PASIEN"];?>' class='btn btn-sm btn-danger'>Hapus</a>
					</td>
				</tr>
				<?php
				$no++;
