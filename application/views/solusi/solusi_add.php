...
<html>
  <head>
    ...
    <title>Bootstrap Material PENYAKIT by Bootstrapious.com</title>
  ...
  <body>
    <div class="page">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    ...
                    <li><a href="<?php echo site_url('Admin')?>"> <i class="icon-user"></i>Manajemen User</a></li>  
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <select title="pilih pasien" class="form-control" name="ID_PENYAKIT" >
            <option value="">--Pilih Penyakit--</option>
            <?php foreach ($tampil_penyakit as $lihat_penyakit) {
            ?>
            <option value='<?= $lihat_penyakit->ID_PENYAKIT ?>'><?= $lihat_penyakit->NAMA_PENYAKIT ?></option>
            <?php } ?>
          </select>
        </div>
      </div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="nama" class="form-control" name="NAMA_SOLUSI" value="<?=isset($default['NAMA_SOLUSI'])? $default['NAMA_SOLUSI'] : ""?>">
				</div>
			</div>
			<center>
